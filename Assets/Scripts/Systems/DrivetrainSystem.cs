...
public partial struct DrivetrainSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var wheelProperties in SystemAPI.Query<RefRW<WheelProperties>>())
        {
            ...
            float inertia = driveTrainComponent.ValueRO.EngineInertia * MathExtensions.Sqr(ratio);
            ...
            else
            {
                ...
                if (wheelProperties.ValueRO.CanDrive)
                {
                    ...
                    wheelProperties.ValueRW.DriveFrictionTorque = engineFrictionTorque * math.abs(ratio) * drivetrainFraction;
                ...
                driveTrainComponent.ValueRW.EngineAngularVelocity = averageAngularVelo * ratio;
            }
